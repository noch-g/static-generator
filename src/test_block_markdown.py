...
class TestMarkdownToHtml(unittest.TestCase):
    ...
    def test_inline_in_list_blocks(self) -> None:
        md = textwrap.dedent("""\
            - Hello **bold**
            - and _italic_
        """)
...
class TestBlockToHTML(unittest.TestCase):
    def test_heading_block_html(self) -> None:
    ...
    def test_quote_block_html(self) -> None:
        children: list[HTMLNode] = [LeafNode(None, "quote\nsecond "), LeafNode("b", "line")]
    ...
    def test_paragraph_html(self) -> None:
